...
<div class="mdl-layout mdl-js-layout <?php if($conf["sidebar"] != "") echo "mdl-layout--fixed-drawer" ?>
    ...
    <div class="mdl-layout__drawer <?php if (tpl_getConf("protrudingDrawer") == 1) echo "mdl-layout__drawer--out"; ?>">
        <section class="drawer-top">
            <span class="mdl-logo"><?php tpl_link(wl(), '<img src="' . tpl_getMediaFile(array(':wiki:Analitic-Icono.png', ':Analitic-Icono.png', 'images/Analitic-Icono.png')) . '" alt="' . $conf['title'] . '" />', 'id="dokuwiki__top" accesskey="h" title="[H]"'); ?></span>
            <br>
            <?php if ($conf['tagline']): ?>
