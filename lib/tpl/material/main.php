...
<div class="mdl-layout mdl-js-layout <?php if($conf["sidebar"] != "") echo "mdl-layout--fixed-drawer" ?>
    ...
    <header class="mdl-layout__header">
        <div class="mdl-layout__header-row">
            <span class="mdl-layout-title content-title">Bienvenido a Wikilitic</span>
    ...
    <div class="mdl-layout__drawer <?php if (tpl_getConf("protrudingDrawer") == 1) echo "mdl-layout__drawer--out"; ?>">
        <section class="drawer-top">
            <span class="mdl-logo"><?php tpl_link(wl(), '<img src="' . tpl_getMediaFile(array(':wiki:Analitic-Icono.png', ':Analitic-Icono.png', 'images/Analitic-Icono.png')) . '" alt="' . $conf['title'] . '" !important"/>', 'id="dokuwiki__top" accesskey="h" title="wikilitic"'); ?> </span>
